...
namespace JsonExample2024
{
    ...
    {
        public static MonkeyList Deserializer(string json)
        {
            List<Monkey> monkeys = JsonSerializer.Deserialize<List<Monkey>>(json);
            MonkeyList monkeyList = new MonkeyList() { Monkeys=monkeys };
            return monkeyList;
        }
        static void Main(string[] args)
        {
            ...
            MonkeyList monkeyList = Deserializer(text);
            Console.WriteLine(monkeyList.ToString());
        }
